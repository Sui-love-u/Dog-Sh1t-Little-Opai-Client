...
import cn.gym.events.impl.player.MoveEvent;
...
public class MovementUtils implements Instance {
    ...
    public static boolean isSuitableMotionTime() {
        BlockPos playerPos = new BlockPos(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ);

        Block playerBlock = mc.theWorld.getBlockState(playerPos).getBlock();

        if (playerBlock instanceof BlockSlab) {
            return false;
        }
        if (playerBlock instanceof BlockBed) {
            return false;
        }
        if (playerBlock instanceof BlockStairs) {
            return false;
        }
    ...
    public static void strafe(MoveEvent event, double dir, double speed) {
        ...
        if (MovementUtils.isMoving2()) {
            MovementUtils.mc.thePlayer.motionX = -Math.sin(direction) * speed;
            event.setX(MovementUtils.mc.thePlayer.motionX);
            MovementUtils.mc.thePlayer.motionZ = Math.cos(direction) * speed;
            event.setZ(MovementUtils.mc.thePlayer.motionZ);
        } else {
    ...
    public static boolean isMoving2() {
        boolean forward = Keyboard.isKeyDown(MovementUtils.mc.gameSettings.keyBindForward.getKeyCode());
        boolean back = Keyboard.isKeyDown(MovementUtils.mc.gameSettings.keyBindBack.getKeyCode());
        boolean left = Keyboard.isKeyDown(MovementUtils.mc.gameSettings.keyBindLeft.getKeyCode());
        boolean right = Keyboard.isKeyDown(MovementUtils.mc.gameSettings.keyBindRight.getKeyCode());
