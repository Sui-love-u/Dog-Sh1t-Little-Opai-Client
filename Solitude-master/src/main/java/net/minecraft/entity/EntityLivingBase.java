...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        if (Solitude.Instance.getModuleManager().getModule(Animations.class).getState() && this == Minecraft.getMinecraft().thePlayer) {
            return (int) (6 + Solitude.Instance.getModuleManager().getModule(Animations.class).getSlowdown().get());
        } else {
