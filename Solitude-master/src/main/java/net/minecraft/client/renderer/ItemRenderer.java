...
import cn.gym.module.impl.render.Animations;
import cn.gym.module.impl.render.NoHurtCam;
...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLivingBase entityIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform)
    {
        if (heldStack != null)
        {
            ...
            if (this.itemRenderer.shouldRenderItemIn3D(heldStack))
            {
                ...
                Animations animations = Solitude.Instance.getModuleManager().getModule(Animations.class);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            GlStateManager.pushMatrix();
            KillAura aura = Solitude.Instance.getModuleManager()
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || (aura.isSword() && aura.blocking && aura.shouldBlock() && !aura.targets.isEmpty() || aura.autoblockmode.is("Watchdog") && aura.isSword() && aura.shouldBlock() && !aura.targets.isEmpty()) || animations.getBlockWhenSwing().get() && mc.thePlayer.isSwingInProgress)
                {
    ...
    {
        if (Solitude.Instance.getModuleManager().getModule(NoHurtCam.class).getState()) {
            return;
        }
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
