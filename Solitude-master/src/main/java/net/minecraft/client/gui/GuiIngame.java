...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Solitude.Instance.getModuleManager().getModule(Interface.class).renderShaders();
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            float f = this.zLevel;
            this.zLevel = -90.0F;
            if (Interface.hotbar.get()) {
                RoundedUtil.drawRound(i - 91, sr.getScaledHeight() - 22, 182, 22, 6, new Color(0, 0, 0, 100));
                RoundedUtil.drawRound(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22, 24, 22, 6, ColorUtil.applyOpacity3(Solitude.Instance.getModuleManager().getModule(Interface.class).color(0),0.5f));
            }else {
    ...
    {
        if (Solitude.Instance.getModuleManager().getModule(cn.gym.module.impl.display.Scoreboard.class).getState()) return;
