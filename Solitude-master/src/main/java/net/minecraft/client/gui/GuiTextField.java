...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                RoundedUtil.drawRoundOutline(this.xPosition - 1, this.yPosition - 1, this.width + 1, this.height + 1,4,1, new Color(31,31,31), new Color(51,51,51));
            }
            ...
            {
                FontManager.Semibold.get(18).drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    RoundedUtil.drawRound(k1, i1 - 1, k1 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT,4, new Color(1,1,1));
                }
                else
                {
                    FontManager.Semibold.get(18).drawStringWithShadow("_", (float)k1, (float)i1, i);
                }
            }
