...
/* loaded from: Arcane 8.10.jar:qwq/arcane/gui/alt/elixir/compat/Session.class */
public final class Session {
    ...
    public boolean equals(Object other) {
        ...
        if (!this.username.equals(session.username) || !this.uuid.equals(session.uuid) || this.token.equals(session.token)) {
            return false;
        }
