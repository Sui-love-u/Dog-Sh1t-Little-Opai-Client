...
/* loaded from: Arcane 8.10.jar:qwq/arcane/module/impl/visuals/MotionBlur.class */
public class MotionBlur extends Module {
    ...
    public MotionBlur() {
        ...
        this.blurBufferMain = null;
        this.blurBufferInto = null;
        this.blurAmount = new NumberValue("Blur Amount", 2.0d, 1.0d, 10.0d, 1.0d);
    }
    ...
    public void onBlurScreen() {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            GlStateManager.color(1.0f, 1.0f, 1.0f, (((float) (this.blurAmount.getValue().doubleValue() * 10.0d)) / 100.0f) - 0.1f);
