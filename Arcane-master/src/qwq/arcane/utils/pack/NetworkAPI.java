...
/* loaded from: Arcane 8.10.jar:qwq/arcane/utils/pack/NetworkAPI.class */
public class NetworkAPI implements Instance {
    ...
    private static Packet<?> instantiatePacket(final EnumPacketDirection direction, final int id, final Object... params) {
        ...
        try {
            ...
            ChatUtils.sendMessage("Failed to instantiate packet!");
