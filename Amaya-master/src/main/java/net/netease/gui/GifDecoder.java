...
public final class GifDecoder {
    ...
    static int readImgDescr(GifFrame fr, byte[] in, int i) {
        ...
        fr.wh = fr.w * fr.h;
        byte b2 = in[++i];
        fr.hasLocColTbl = (b2 & 0x80) >>> 7 == 1;
        fr.interlaceFlag = (b2 & 0x40) >>> 6 == 1;
        fr.sortFlag = (b2 & 0x20) >>> 5 == 1;
        int colTblSizePower = (b2 & 7) + 1;
    ...
    static int readLogicalScreenDescriptor(GifImage img, byte[] in, int i) {
        ...
        img.wh = img.w * img.h;
        byte b2 = in[i + 4];
        img.hasGlobColTbl = (b2 & 0x80) >>> 7 == 1;
        int colResPower = ((b2 & 0x70) >>> 4) + 1;
        img.colorResolution = 1 << colResPower;
        img.sortFlag = (b2 & 8) >>> 3 == 1;
        int globColTblSizePower = (b2 & 7) + 1;
