...
extends GuiScreen {
    ...
    private final List<GermGameElement> elements = new ArrayList<GermGameElement>();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float switchOutput = (float)this.switchScreenAnim.getOutput().intValue();
        ...
        FontManager.REGULAR.get(32).drawStringWithShadow("Germ Game", this.x + 20.0f, this.y + 8.0f, -1);
        int count = 0;
        float offsetX = 0.0f;
        float offsetY = 0.0f;
        for (GermGameElement element : this.elements) {
            ...
            if (hovering && !this.switchScreenAnim.isState()) {
                ...
                for (String hoverDos : element.getHoverDos()) {
                    FontManager.REGULAR.get(18).drawStringWithShadow(hoverDos, mouseX + 15, (float)(mouseY - (FontManager.REGULAR.get(18).getHeight() + 4) * 2) + textOffsetY, -1);
                    textOffsetY += (float)(FontManager.REGULAR.get(18).getHeight() + 4);
                }
            }
            if (++count % 3 == 0) {
        ...
        if (this.switchScreenAnim.isState() || !this.switchScreenAnim.isDone()) {
            RenderUtil.startGlScissor((int)originalX, (int)this.y, (int)this.width, (int)this.height);
            RoundedUtil.drawRound(doubleX + 10.0f, this.y + 10.0f, 20.0f, 20.0f, 10.0f, new Color(0, 0, 0, 150));
            this.backButtonRipple.draw(() -> RoundedUtil.drawRound(doubleX + 10.0f, this.y + 10.0f, 20.0f, 20.0f, 10.0f, Color.WHITE));
            this.backHoverAnim.setState(RenderUtil.isHovering(doubleX + 20.0f - (float)FontManager.iconfont.get(22).getStringWidth("y") / 2.0f, this.y + 20.0f - (float)(FontManager.iconfont.get(22).getHeight() / 2), FontManager.iconfont.get(22).getStringWidth("y"), FontManager.iconfont.get(22).getHeight(), mouseX, mouseY));
            Color hoverColor = ColorUtil.interpolateColorC(Color.WHITE, ColorUtil.darker(Color.WHITE, 0.6f), (float)this.backHoverAnim.getOutput().intValue());
            ...
            FontManager.iconfont.get(22).drawStringWithShadow("y", doubleX + 20.0f - (float)FontManager.iconfont.get(22).getStringWidth("y") / 2.0f, this.y + 22.0f - (float)(FontManager.iconfont.get(22).getHeight() / 2), hoverColor.getRGB());
            FontManager.iconfont.get(22).drawCenteredStringWithShadow("Sub Game", doubleX + this.width / 2.0f, this.y + 10.0f, -1);
            if (this.currentElement != null) {
                ...
                for (GermGameSubElement element : this.currentElement.getSubElements()) {
                    ...
                    Color hovColor = ColorUtil.interpolateColorC(color, new Color(0, 0, 0, 200), (float)element.getHoverAnim().getOutput().floatValue());
                    RoundedUtil.drawRound(x, y, width, height, 7.0f, hovColor);
                    FontManager.REGULAR.get(18).drawCenteredStringWithShadow(element.getName(), x + width / 2.0f, y + 12.0f, -1);
                    float descOffsetY = 0.0f;
                    for (String s : element.getDesc()) {
                        FontManager.REGULAR.get(10).drawStringWithShadow(s, x + 5.0f, y + height - (float)(element.getDesc().size() * 10) + descOffsetY, -1);
                        descOffsetY += 10.0f;
                    }
    ...
    public List<GermGameElement> getElements() {
        return this.elements;
    }

    public GermGameElement getCurrentElement() {
    ...
    public Animation getSwitchScreenAnim() {
        return this.switchScreenAnim;
    }

    public Animation getBackHoverAnim() {
    ...
    public RippleAnimation getBackButtonRipple() {
    ...
    public void setCurrentElement(GermGameElement currentElement) {
    ...
    public void setBackButtonRipple(RippleAnimation backButtonRipple) {
