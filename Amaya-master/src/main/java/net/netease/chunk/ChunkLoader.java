...
IThreadedFileIO {
        ...
        for (int var9 = 0; var9 < i1; ++var9) {
            ...
            for (int i = 0; i < extendedblockstorage.getData().length; ++i) {
                ...
                if (c0 >> 12 != 0) {
                    ...
                    nibblearray1.set(j2, k, l, c0 >> 12);
                }
                abyte[i] = (byte)(c0 >> 4 & 0xFF);
                nibblearray.set(j2, k, l, c0 & 0xF);
            }
    ...
    private Chunk readChunkFromNBT(World worldIn, NBTTagCompound p_75823_2_) {
        ...
        Chunk chunk = new Chunk(worldIn, i, j2);
        ...
        for (int l = 0; l < nbttaglist.tagCount(); ++l) {
            ...
            for (int j1 = 0; j1 < achar.length; ++j1) {
                ...
                int l1 = j1 >> 8 & 0xF;
                int i2 = j1 >> 4 & 0xF;
                int j22 = nibblearray1 != null ? nibblearray1.get(k1, l1, i2) : 0;
                achar[j1] = (char)(j22 << 12 | (abyte[j1] & 0xFF) << 4 | nibblearray.get(k1, l1, i2));
            }
