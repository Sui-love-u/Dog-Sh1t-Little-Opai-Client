...
import com.amaya.module.impl.render.PostProcessing;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Amaya.Instance.getModuleManager().getModule(PostProcessing.class).renderShaders();
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer entityplayer) {
            ...
            float f = zLevel;
            zLevel = -90.0F;
            anim = AnimationUtils.moveUDFaster(anim, entityplayer.inventory.currentItem * 20);
            if (PostProcessing.bloom.get() && Amaya.Instance.moduleManager.getModule(PostProcessing.class).getState()) {
                GlowUtils.drawGlow(i - 90, animUp, 90 << 1, 20, PostProcessing.shadowRadius.getValue().intValue(), new Color(0, 0, 0, 90));
            }
            RoundedUtil.drawRound(i - 90, animUp, 90 << 1, 20, 6, new Color(0, 0, 0, 150));
            RoundedUtil.drawRound(i - 90 + anim, animUp, 20, 20, 6, new Color(233, 233, 233, 100));
            zLevel = f;
