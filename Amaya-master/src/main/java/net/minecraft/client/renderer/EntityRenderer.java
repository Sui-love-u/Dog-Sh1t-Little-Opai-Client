...
import com.amaya.module.impl.render.Camera;
import com.amaya.module.impl.render.MotionBlur;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (Amaya.Instance.moduleManager.getModule(NoHurtCam.class).getState()) {
            return;
        }
    ...
    public void orientCamera(float partialTicks)
    {
        ...
        Entity entity = this.mc.getRenderViewEntity();
        Camera camera = Amaya.Instance.moduleManager.getModule(Camera.class);
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                if (camera.motionCamera.getConfigValue()) {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventManager.call(new Render3DEvent(partialTicks,new ScaledResolution(mc)));
        MotionBlur motionBlur = Amaya.Instance.moduleManager.getModule(MotionBlur.class);
