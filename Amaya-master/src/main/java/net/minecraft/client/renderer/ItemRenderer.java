...
import com.amaya.module.impl.render.Animations;
import com.amaya.module.impl.render.NoHurtCam;
...
public class ItemRenderer
{
    ...
    public void renderItem(EntityLivingBase entityIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform)
    {
        if (heldStack != null)
        {
            ...
            if (this.itemRenderer.shouldRenderItemIn3D(heldStack))
            {
                ...
                Animations animations = Amaya.Instance.getModuleManager().getModule(Animations.class);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            GlStateManager.pushMatrix();
            KillAura aura = Amaya.Instance.getModuleManager()
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || aura.isBlocking() || animations.getBlockWhenSwing().get() && mc.thePlayer.isSwingInProgress)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case DRINK:
                            ...
                            this.transformFirstPersonItem(f, animations.getState() && animations.getOld().get() ? f1 : 0);
                            break;
                ...
                if (animations.getState() && animations.getOld().get() && !itemRenderer.shouldRenderItemIn3D(itemToRender)) {
    ...
    {
        if(Amaya.Instance.moduleManager.getModule(NoHurtCam.class).getState()){return;}
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
