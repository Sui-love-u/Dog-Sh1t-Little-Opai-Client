...
import com.amaya.events.impl.misc.ClickEvent;
...
import com.amaya.gui.mainmenu.MainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame(String name) throws LWJGLException, IOException
    {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    if (this.thePlayer.isSpectator() && i == 2) {
                        ClickEvent eventClick = new ClickEvent(Mouse.getEventButton());
            ...
            if (!event.isCancelled()) {
                if (this.thePlayer.isUsingItem()) {
                    ...
                    while (this.gameSettings.keyBindAttack.isPressed()) {
                        if (Amaya.Instance.getModuleManager().getModule(Animations.class).getState() &&
                                Amaya.Instance.getModuleManager().getModule(Animations.class).getSwingWhileUsingItem().get()) {
