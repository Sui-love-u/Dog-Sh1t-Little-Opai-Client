...
public class Cartesian
{
    ...
    static class Product<T> implements Iterable<T[]>
    {
        ...
        {
            Iterator<T[]> iterator = (this.iterables.length <= 0 ? Collections.singletonList((T[]) Cartesian.createArray(this.clazz, 0)).iterator() : new ProductIterator(this.clazz, this.iterables));
            return iterator;
        }
