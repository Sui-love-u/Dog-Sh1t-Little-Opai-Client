...
import com.amaya.module.impl.movement.NoJumpDelay;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        if (Amaya.Instance.moduleManager.getModule(Animations.class).getState() && this == Minecraft.getMinecraft().thePlayer) {
            return (int) (6 +Amaya.Instance.moduleManager.getModule(Animations.class).getSlowdown().get());
        } else {
    ...
    public void moveEntityWithHeading(float strafe, float forward) {
        EventMoveMath motionEvent = new EventMoveMath();
    ...
    public void onLivingUpdate()
    {
        ...
        NoJumpDelay noJumpDelay = nojumpdelay = Amaya.Instance != null ? Amaya.Instance.getModuleManager().getModule(NoJumpDelay.class) : null;
        if (nojumpdelay != null && Minecraft.getMinecraft().thePlayer != null && nojumpdelay.getState()) {
            this.jumpTicks = 0;
        }
        if (this.jumpTicks > 0) {
            --this.jumpTicks;
