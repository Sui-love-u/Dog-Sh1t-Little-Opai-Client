...
import com.amaya.utils.animations.impl.ColorAnimation2;
...
public class InputField extends Gui {
    ...
    private ColorAnimation2 realFillColor = new ColorAnimation2(new Color(0, 0, 0, 144));
    /**
...
//    private final Animation cursorBlinkAnimation = new DecelerateAnimation(750, 1);
    ...
    public InputField(FontRenderer font) {
        this.font = font;
    }

    public InputField(FontRenderer font, float x, float y, float par5Width, float par6Height) {
        this.font = font;
        this.xPosition = x;
        this.yPosition = y;
    ...
    /**
     * gets the position of the nth word. N may be amaya, then it looks backwards. params: N, position
     */
        ...
        if (this.getVisible()) {
            ...
            if (backgroundText != null) {
                ...
                if (text.equals("") /* && !(textColor == 0)*/) {
                    font.drawString(backgroundText, xPos, yPos, new Color(255,255,255).getRGB());
                }
            }
