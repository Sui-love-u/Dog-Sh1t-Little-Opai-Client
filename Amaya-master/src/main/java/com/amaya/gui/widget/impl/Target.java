...
import com.amaya.utils.render.ParticleRenderer;
 ...
 * 2025/5/10
 */
public class Target extends Widget {
    public Target() {
        super("TargetHUD");
        this.x = 0.5f;
        this.y = 0.8f;
    }
    private com.amaya.module.impl.display.TargetHUD value = Amaya.Instance.moduleManager.getModule(com.amaya.module.impl.display.TargetHUD.class);
    ...
    public void render() {
        ...
        for (EntityPlayer target : setting.animationEntityPlayerMap.keySet()) {
            ...
            if (count > 9) continue;
            TargetHUD targetHUD = new TargetHUD((float) (renderX + ((count % 3) * (lastTargetWidth + 4)) * setting.animationEntityPlayerMap.get(target).getOutput()), (float) (this.renderY + ((count / 3) * (this.height + 4)) * setting.animationEntityPlayerMap.get(target).getOutput()), target, setting.animationEntityPlayerMap.get(target), false, value.targetHudMode);
            targetHUD.render();
    ...
    public float getTHUDWidth(Entity entity) {
        return switch (value.targetHudMode.get()) {
            case "Type 1" -> Math.max(120, FontManager.BOLD.get(18).getStringWidth(entity.getName()) + 50);
            ...
            case "Exhi" -> Math.max(124.0f, FontManager.BOLD.get(17).getStringWidth(entity.getName()) + 54.0f);
            case "Adjust" -> 130;
            case "Moon" -> 35 + FontManager.SEMIBOLD.get(18).getStringWidth(entity.getName()) + 33;
            case "Augustus" -> 35 + FontManager.SEMIBOLD.get(18).getStringWidth(entity.getName()) + 33;
            case "New" -> Math.max(160, FontManager.SEMIBOLD.get(17).getStringWidth(entity.getName()) + 30);
            ...
            case "Novo 4" -> 135.0f;
            case "Novo 5" -> Math.max(118, FontManager.SEMIBOLD.get(17).getStringWidth(entity.getName()) + 38) + 27F;
            case "Akrien" -> 114 + ((35 + FontManager.SEMIBOLD.get(21).getStringWidth(entity.getName())) / 25f);
            case "Felix" -> 140.0f;
            case "Innominate" -> Math.max(78, FontManager.SEMIBOLD.get(17).getStringWidth(entity.getName()) + 39) + 22;
            default -> 0;
        };
    }
...
class TargetHUD implements InstanceAccess {
    ...
    public TargetHUD(float x, float y, EntityPlayer target, Animation animation, boolean shader, ModeSetting style) {
        this.x = x;
        this.y = y;
        this.target = target;
    ...
    public void render() {
        setWidth(INSTANCE.getWidgetManager().get(Target.class).getTHUDWidth(target));
        setHeight(INSTANCE.getWidgetManager().get(Target.class).getTHUDHeight());
        ...
        switch (style.get()) {
            case "Astolfo": {
                if (!shader) {
                    ...
                    mc.fontRendererObj.drawStringWithShadow(String.format("%.1f", target.getHealth()) + " ❤", (x + 50) / 1.5f, (y + 22) / 1.5f, value.color(1));
                    ...
                    RoundedUtil.drawRound(x + 48, y + 42, width - 54, 7, 0, ColorUtil.applyOpacity(new Color(value.color(1)).darker().darker().darker(), (float) (1 * animation.getOutput())));
                    RoundedUtil.drawRound(x + 48, y + 42, target.healthAnimation.getOutput(), 7, 0, ColorUtil.applyOpacity(new Color(value.color(1)), (float) (1 * animation.getOutput())));
                } else {
            ...
            case "Type 1": {
                ...
                if (!shader) {
                    ...
                    FontManager.BOLD.get(18).drawString(target.getName(), x + 43, y + 10, ColorUtil.applyOpacity(Color.WHITE, (float) animation.getOutput().intValue()).getRGB());
                    FontManager.BOLD.get(14).drawString("HP: " + String.format("%.1f", target.healthAnimation.getOutput() / (width - 52) * target.getMaxHealth()), x + 43, y + 20, ColorUtil.applyOpacity(Color.WHITE, (float) animation.getOutput().intValue()).getRGB());
                    RoundedUtil.drawRound(x + 44, y + 30, width - 52, 6, 3, ColorUtil.applyOpacity(Color.BLACK, (float) (.47f * animation.getOutput())));
                    RoundedUtil.drawGradientHorizontal(x + 44, y + 30, target.healthAnimation.getOutput(), 6, 3, ColorUtil.applyOpacity(new Color(value.color(0)), (float) animation.getOutput().intValue()), ColorUtil.applyOpacity(new Color(value.color(10)), (float) animation.getOutput().intValue()));
                } else {
            ...
            case "Type 2": {
                if (!shader) {
                    ...
                    FontManager.SEMIBOLD.get(14).drawString(target.getDisplayName().getFormattedText(), x + 5 * 3 + 26.5f, y + 6.8f + (float) FontManager.SEMIBOLD.get(14).getHeight() / 2, -1);
                    FontManager.REGULAR.get(12).drawString((int) (MathUtils.roundToHalf(target.getHealth())) + "HP", x + 5 * 3 + 26.5f, y + 6.8f * 2.25 + (float) FontManager.SEMIBOLD.get(14).getHeight() / 2, -1);

                    RoundedUtil.drawGradientHorizontal(x + 5 * 3 + 26.5f, y + 26.5f, target.healthAnimation.getOutput(), 3.8f, 2, new Color(value.color(0)), new Color(value.color(90)));

                    RenderUtil.drawRect(x + 5 * 3 + 26.5f + FontManager.REGULAR.get(12).getStringWidth((int) (MathUtils.roundToHalf(target.getHealth())) + "HP") + 2, y + 6.8f * 2.25f + 1.5f, 0.5f, FontManager.REGULAR.get(12).getHeight(), new Color(128, 128, 128).getRGB());
                    ...
                    for (ItemStack stack : items) {
                        RenderUtil.renderItemStack(stack, i + x + 5 * 3 + 26.5f + FontManager.REGULAR.get(12).getStringWidth((int) (MathUtils.roundToHalf(target.getHealth())) + "HP") + 2 + 1, y + 6.8f * 2.25f + 1.5f, 0.5f);
                        i += 7.5f;
                    }

                } else {
                    RoundedUtil.drawGradientHorizontal(x, y, width, height, 4, new Color(value.color(0)), new Color(value.color(90)));
                }
            ...
            case "Exhi": {
                ...
                FontManager.BOLD.get(17).drawString(target.getName(), 42.0f, 1f, -1);
                FontManager.REGULAR.get(10, false).drawString("HP: " + (int) totalHealth + " | Dist: " + (int) mc.thePlayer.getDistanceToEntity(target), 42.5f, 15.5f, -1);
                java.util.List<ItemStack> items = new java.util.ArrayList<>();
                if (target.getHeldItem() != null) {
                    items.add(target.getHeldItem());
                }
            ...
            case "Adjust": {
                ...
                if (!shader) {
                    ...
                    RenderUtil.drawRect(healthX, y + height - 5, width - padding * 2, 4, ColorUtil.darker(value.color(0), 0.3f));
                    RenderUtil.drawRect(healthX, y + height - 5, target.healthAnimation.getOutput(), 4, value.color(0));
                    RenderUtil.renderPlayer2D(target, x + padding, y + padding, 28 - padding, 0, -1);

                    FontManager.REGULAR.get(15).drawStringWithShadow(target.getName(), x + padding + 30, y + 3 + padding, -1);
                    FontManager.REGULAR.get(15).drawStringWithShadow(healthDiff, x + width - padding - FontManager.REGULAR.get(15).getStringWidth(healthDiff), y + height - 5 * 2 - padding, -1);
            ...
            case "Moon": {
                ...
                if (!shader) {
                    ...
                    RoundedUtil.drawRound(x + 42, y + 26.5f, target.healthAnimation.getOutput(), 8.5f, 4, new Color(value.color(0)));
                    RenderUtil.renderPlayer2D(target, x + 2.5f, y + 2.5f, 35, 10, -1);
                    FontManager.SEMIBOLD.get(13).drawStringWithShadow(text + "HP", x + 40, y + 17, -1);
                    FontManager.SEMIBOLD.get(18).drawStringWithShadow(target.getName(), x + 40, y + 6, -1);
                } else {
                    RoundedUtil.drawRound(x, y, width, height, 8, new Color(value.color()));
                }
            ...
            case "Augustus": {
                ...
                if (!shader) {
                    ...
                    FontManager.SEMIBOLD.get(18).drawString(target.getName(), x + 52.5F, y + 10.5f, -1);
                } else {
                    RoundedUtil.drawRound(x, y, width, height, 8, new Color(value.color()));
                }
            ...
            case "New": {
                ...
                if (!shader) {
                    ...
                    RoundedUtil.drawRound(x + 42, y + 22f, target.healthAnimation.getOutput(), 6f, 3, new Color(value.color(0)));
                    RoundedUtil.drawRoundOutline(x, y, this.width, this.height, 5, 0.1f, new Color(0, 0, 0, 0), new Color(value.color(0)));
                    RenderUtil.renderPlayer2D(target, x + 4.0f, y + 3.3f, 33, 12, -1);
                    FontManager.SEMIBOLD.get(19).drawString(text + "  ", x + 134, y + 9, value.color());
                    FontManager.SEMIBOLD.get(17).drawString(target.getName(), x + 42, y + 9, value.color());
                } else {
                    RoundedUtil.drawRound(x, y, width, height, 3, new Color(value.color()));
                    RoundedUtil.drawRoundOutline(x, y, this.width, this.height, 5, 0.1f, new Color(0, 0, 0, 0), new Color(value.color(0)));
                }
            ...
            case "Novo 2": {
                ...
                if (!shader) {
                    ...
                    String text = String.format("%.1f", target.getHealth());
                    mc.fontRendererObj.drawStringWithShadow("❤", x + 62 + 1, y + 26.6f, value.color(0));
                    RenderUtil.drawRect(x + 40 + 1, y + 16.5f, target.healthAnimation.getOutput(), 8.8f, value.color(0));
            ...
            case "Novo 3": {
                ...
                if (!shader) {
                    ...
                    RenderUtil.drawRect(x + 40 + 1, y + 16.5f, target.healthAnimation.getOutput(), 10.8f, value.color());
            ...
            case "Novo 5": {
                ...
                float healthPercentage = target.getHealth() / target.getMaxHealth();
                float space = width - FontManager.REGULAR.get(17).getStringWidth("20.0") - 3 - 3.2f;

                target.healthAnimation.animate(space * MathHelper.clamp_float(healthPercentage, 0, 1), 30);

                if (!shader) {
                    RenderUtil.drawRect(x, y, width, height, value.bgColor());
                    FontManager.REGULAR.get(20).drawStringWithShadow(target.getName(), x + 40f, y + 3.2f + 1, -1);
                    String text = String.format("%.1f", target.getHealth());
                    FontManager.REGULAR.get(17).drawString(text, x + target.healthAnimation.getOutput() + 3, y + 37F, -1);
                    RenderUtil.renderPlayer2D(target, x + 3.2f, y + 3.2f, 33, 0, -1);
                    RenderUtil.drawGradientRect(x + 3.2f, y + 39, target.healthAnimation.getOutput(), 4, true, value.color(0), value.color(90));
                    ...
                    RenderUtil.drawRect(x, y, width, height, value.color(0));
                }
            }
            ...
            case "Akrien": {
                ...
                if (!shader) {
                    ...
                    FontManager.REGULAR.get(15).drawStringWithShadow("Health: " + text, x + 32.5f, y + 16f + 2, -1);
                    FontManager.REGULAR.get(15).drawStringWithShadow("Distance: " + text2 + "m", x + 32.5f, y + 24.5f + 2, -1);
                    FontManager.BOLD.get(21).drawStringWithShadow(target.getName(), x + 32.5f, y + 3 + 2, -1);

                    RenderUtil.renderPlayer2D(target, x + 1, y + 3, 30, 0, -1);
                } else {
                    RenderUtil.drawRect(x, y, width, height, value.color());
                }
            }
            break;
            ...
            case "Innominate": {
                ...
                if (!shader) {
                    ...
                    String text = String.format("%.1f", target.getHealth());
                    FontManager.REGULAR.get(16).drawStringWithShadow(target.getName() +  " | " + text, x + 2, y + 2 + 2, -1);

                    RenderUtil.renderItemStack(target,x + 2,y + 2 + FontManager.REGULAR.get(16).getHeight(),1,false,0,false,false);

                    RenderUtil.drawBorderedRect(x + 2,y + 2 + FontManager.REGULAR.get(16).getHeight() + 16,width - 4,5,1,Color.BLACK.getRGB(),Color.DARK_GRAY.getRGB());

                    RenderUtil.drawBorderedRect(x + 2,y + 2 + FontManager.REGULAR.get(16).getHeight() + 16,target.healthAnimation.getOutput(),5,1,value.color(0),Color.DARK_GRAY.getRGB());
                } else {
                    RenderUtil.drawBorderedRect(x, y, width, height,1, Color.BLACK.getRGB(),Color.DARK_GRAY.getRGB());
                }
            }
